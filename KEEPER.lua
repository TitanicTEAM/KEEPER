...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"وعليكم السلام والرحمه⇣😻","يمه هلا بالغالي 😻🍃","وعليكم السلام حبيبي ☺️🍃","كافي بس تسلمون 🌝💔","عليكم السلام اقاتي🖖🏿🌝","😍هله ومرحبا برب العافيه❤️" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {'اي نعم اني '..(redis:get(KEEPER..'keepernams') or 'شلش')..' 🍃😐','اهو هم انته علیه ردتك عون صرتلي فرعون 😹😪','كافي تره كرهت اسمي 💔😠','ها حبي اامرني☺️','ها حبي شوف شوف عضلاتي 💪','راح اهفك/ج بكله اخربط واهس وجهك/ج😒','تف 💦😙 عليك','ها اروح لل🚽 هسه اجي😣🏃🏃','ها حب 😍تبي/ن بوسه 💋ولا 💞💍','اوكف بطني توجع 😣هسه اجي🚶🏃🏃','شفيك اولدي مريض 😒اذا تبي اعالجك💉','المطور الي اسمه شهاب كال لو اي واحد يصيحك اتفل علي 🐸معليه اني','لتصيحني نايم بلخاص 🌝✋🏿','انجب دوختوني 😖','استغرفك ياربي لاتضل تصيحني لا اشبعك حظر 🌝😂'}
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-------------------------------------------------
...
-----------------------------------------
if text == "غنیلی" or text == "غنيلي" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
...
if text == "💋" or text == "💋💋" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"كبر 🙀 جان استحيتو 😹😹","عســـل 😋🙊","اووف يمه شنو هاي 😋🙊","😍💋لصق ع الشفه اقاتي","💔💋ياليلي ويا سواد ليلي شنو هاي ربي" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------

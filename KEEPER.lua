...
👲🏾┇ تعطيل الخروج التلقائي'
🗣┇ جلب رابط + ايدي المجموعه"

🗯┇ الشحن + (30or60or90)+يدي
🎙┇ الشحن + (30 or 60 or 90)'
🎬┇ كشف + ايدي المجموعه
👮🏾‍♀️┇ مسح الحسابات المحذوفه'
...
local text = [[
[در پاسخ به تارك/✸ﺷŞɧāɧĀβـهاب✸ F͢b i ᱾ 🇮🇶⁾]
- اوامر ⁽الاعضاء₎ »
...
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ تم قفل الدردشه بالتقييد\n ✓ ", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ الدردشه بالتقييد مقفول سابقا\n ✓ ", 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ الماركدون بالتقييد مقفول سابقا\n ✓ ", 1, 'md')
end
...
if not redis:get(KEEPER.."keed_user" .. msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ تم قفل المعرف بالتقييد\n ✓ ", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ المعرف بالتقييد مقفول سابقا\n ✓ ", 1, 'md')
end
redis:set(KEEPER.."keed_user" .. msg.chat_id_, true)
end
...
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ تم قفل الهاشتاك بالتقييد\n ✓ ", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ الهاشتاك بالتقييد مقفول سابقا\n ✓ ", 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا سيدي  ... "..tmkeeper(msg).."\n📡┊ تم قفل العربيه بالتقييد\n ✓ ", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ العربيه بالتقييد مقفول سابقا\n ✓ ", 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا سيدي  ... "..tmkeeper(msg).."\n📡┊ تم قفل الانكليزيه بالتقييد\n ✓ ", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا حبيبي  ... "..tmkeeper(msg).."\n📡┊ الانكليزيه بالتقييد مقفول سابقا\n ✓ ", 1, 'md')
end
...
if redis:get(KEEPER.."keed_text" .. msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ ااهلا سيدي  ... "..tmkeeper(msg).."\n📡┊ تم فتح الدردشه بالتقييد\n ✓ ", 1, 'md')
else
...
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا سيدي  ... "..tmkeeper(msg).."\n📡┊ الماركدون بالتقييد مفتوح سابقا\n ✓ ", 1, 'md')
end
...
if redis:get(KEEPER.."keed_arbic" .. msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا سيدي  ... "..tmkeeper(msg).."\n📡┊ تم فتح العربيه بالتقييد\n ✓ ", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا سيدي  ... "..tmkeeper(msg).."\n📡┊ العربيه بالتقييد مفتوح سابقا\n ✓ ", 1, 'md')
end
...
if redis:get(KEEPER.."keed_english" .. msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا سيدي  ... "..tmkeeper(msg).."\n📡┊ تم فتح الانكليزيه بالتقييد\n ✓ ", 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "👮🏽┊ اهلا سيدي  ... "..tmkeeper(msg).."\n📡┊ الانكليزيه بالتقييد مفتوح سابقا\n ✓ ", 1, 'md')
end
...
if not is_sudo(msg) then
send(msg.chat_id_, msg.id_, 1, "👨🏾‍🌾┊ لك تف هذه امر   المطورين  فقط😹\n🚶🏾", 'md')
else
local kpgban = redis:scard(KEEPER.."bot:gban:") or "0"
...
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ تم √ طرد جميع الحسابات المحذوفه 🎋", 1, "md")
end end
-----------------------------------------------
...
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ اهلا حبيبي ...؟🕵🏻\n🚸┊  اذا اردت مسحهم\n👷┊ ارسل لي رقم (1) \n🖐🏿┊ او ارسل (2) لأضافتهم.️\n‏",  1, "md")
...
local kpmomod = redis:scard(KEEPER.."bot:momod:" .. msg.chat_id_) or "0"
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊عدد الأدمنيه ≈ *"..kpmomod.."*\n📡┊ تـم رفعهم بنجاح   ✓‏\n", 1, "md")
end
getChannelMembers(msg.chat_id_, 0, 'Administrators', 200, promote_admin)
end
-------CLEN MSG---------------------------
...
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ امر اطردني معطل 🍃", 1, "md")
return false
end
...
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ ارسل *{ نعم }* لطردك\n📡┊ ارسل *{ لا } *لالغاء طردك", 1, "md")
end
...
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️┊ عذرا لا استطيع (حظر،طرد،كتم)المدراء والادمنيه والاعضاء المميزين 🖐🏿', 1, 'md')
else
local Kpkick = redis:get(KEEPER.."kick_me"..msg.sender_user_id_..""..msg.chat_id_.."")
if Kpkick == "kick_mee" then
chat_kick(msg.chat_id_, msg.sender_user_id_)
...
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ تم طردتك حياتي", 1, "md")
end 
end
end
...
redis:del(KEEPER.."kick_me"..msg.sender_user_id_..""..msg.chat_id_.."","kick_mee")
redis:del(KEEPER.."unkick_me"..msg.sender_user_id_..""..msg.chat_id_.."","kick_no")
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ تم الغاء طردك", 1, "md")
end
end
end
---------------------SEE viewget----------------------------------------
...
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ ارسل لي  الان توجيه  للمنشور 🚶🏾: ", 1, "md")
end end
-----------------SEE ACAUNT---------------------------------------
...
if redis:get(KEEPER.."lang:gp:" .. msg.chat_id_) then
sendmen(msg.chat_id_, msg.id_, "🙋🏻‍♂️┊ (اضغط هنا  عزيزي) 🍃", 2, 22, result.id_)
else
sendmen(msg.chat_id_, msg.id_, "🙋🏻‍♂️┊ (اضغط هنا  عزيزي) 🍃", 2, 22, result.id_)
end
elseif redis:get(KEEPER.."lang:gp:" .. msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ *User Not Found* !", 1, "md")
else
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️┊ لا يوجد حساب 🍂", 1, "md")
end
end
tdcli_function({
ID = "GetUser",
...
local list = redis:smembers(KEEPER.."bot:groups")
local t = '🙋🏻‍♂️┊ ايديات المجموعات \n'
for k,v in pairs(list) do
t = t..k.." » `"..v.."`\n"  end
t = t..''
if #list == 0 then
t = '🙋🏻‍♂️┊ لا توجد مجموعات مفعله' end
send(msg.chat_id_, msg.id_, 1,t, 1, 'md') end end
-----------PHOTO-------------------------------------------------
if text == "صورتي" then
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"🌅┊  انت تمتلك الان ...  "..result.total_count_.." صوره‌‏ 🍃", msg.id_, msg.id_, "md")
else
...
--------------------------------------------------------------------------------------------
if text == ''..(redis:get(KEEPER..'keepernams') or 'شلش')..' بوسه' or text == ''..(redis:get(KEEPER..'keepernams') or 'شلش')..' بوس هاي' then
function reep22(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(KEEPER_SUDO) then
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {'اسمي '..(redis:get(KEEPER..'keepernams') or 'شلش')..' 😌👌','تره اسمي '..(redis:get(KEEPER..'keepernams') or 'شلش')..' يالجريذي ☹️😹'  }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {'اي نعم اني '..(redis:get(KEEPER..'keepernams') or 'شلش')..' 🍃😐','كافي تره كرهت اسمي 💔😠','انجب دوختوني 😖','ها حبيبتي','وسم😊','😐شتريدين','ها حبي كولي منو مضوجك ☺️','عوفني مكبل😎لتحاجيني','ها غلاي','شوف منو😻👋','ضايج ولله يمعود اليوم محضرت واحد وضايج 😣','ها.اليوم ردت اسوي حادث 😢ردت انطي لولد حضر بالغلط😔☝️','دحجي عاد مو سويت بيه كركري','لصيحني مالي خلك😤من هسه اكلك/ج اي احبك/ج بعد لتصيحيني ابو/ام اللبن 😊','لك ممليت✋🏻😳','What?','دولي خرب بيومك/ج شكد لطشت/ي','وياك اثول','ها يبعد جبدي','لتصيحني نايم بلخاص 🌝✋🏿','ي حبي','ها حبوبي 😂سوري ماغلط بعد','اي ايييي😒','اهووو شاف ماشاف 😒','استغرفك ياربي لاتضل تصيحني لا اشبعك حظر 🌝😂','ها 😟','ها قلبي.اريد اكل جوعان 😢','😁ي حياتي','لك لعبت بيه خلقه رح اتفل عليك','شفيك اولدي مريض 😒اذا تبي اعالجك💉','هلاا منور حب','😋ها عمري','اوكف بطني توجع 😣هسه اجي🚶🏃🏃','ها حب 😍تبي/ن بوسه 💋ولا 💞💍','ها اروح لل🚽 هسه اجي😣🏃🏃','شوفي الساعه شكد🕚 شعندك كاعد نام👴🏻','هلا لاحب تبعي 😻✋🏻','هلا بلضلع 😏متبين ليش👌','تف 💦😙 عليك','دحجي شتريد😑','حبيبي','ها حبي شوف شوف عضلاتي 💪','راح اهفك/ج بكله اخربط واهس وجهك/ج😒','انشب 🐸','ها حب.اكلك/ج ليش مانغني سوه سمعت صوتك/ج حلو😄','وياك ولله'}
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-------------------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"جوع الربوع😕","شطبخلك/ج  🙊😋","🙄خو شسويلك ولي اكلك شي","😂تعال اك...","😒عمت عيني عليك/ج" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"دووم الضحكه 🙊🍃","دوم الضحكه ℡̮⇣┆👑😻⇣ۦ ٰ","يومه ضحكه لو عافيه😍","ٰدبسك بس تعرف تكركر😕😒","عابت🙂العتب مو عليك/ج","😂اضحك وكروتك بلاش🚶🏾" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
